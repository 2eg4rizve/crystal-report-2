...
namespace EnterpriseInvoiceSystem.Controllers
{
    ...
    public class CustomersController : ApiController
    {
        ...
        [HttpPost, Route("")]
        public async Task<IHttpActionResult> Post(CreateCustomerRequest r)
        {
        ...
        public async Task<IHttpActionResult> Put(int id, UpdateCustomerRequest r)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            return r == 0 ? (IHttpActionResult)NotFound()
                : r < 0
                    ? Content(
                        ...
                        new
                        {
                            message = "Customer cannot be deleted because invoices reference it.",
                        }
                    )
                : StatusCode(System.Net.HttpStatusCode.NoContent);
        }
