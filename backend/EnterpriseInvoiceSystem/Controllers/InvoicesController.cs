...
namespace EnterpriseInvoiceSystem.Controllers
{
    ...
    {
        readonly InvoiceService service = new InvoiceService();
        ...
        [HttpPost, Route("")]
        public async Task<IHttpActionResult> Post(CreateInvoiceRequest r)
        {
            ...
            catch (ConflictException ex)
            {
                return Content(
                    ...
                    new { message = "Invoice creation failed.", detail = ex.Message }
                );
            }
